...
silent only
cd ~/Dropbox/project/busstoppy
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +126 processdata.py
badd +212 busschedule.json
badd +1 data/ltabusstop.json
badd +58 ~/.vimrc
badd +0 data/mrt.json
argglobal
silent! argdel *
$argadd processdata.py
edit data/ltabusstop.json
...
exe 'vert 1resize ' . ((&columns * 77 + 115) / 231)
exe '2resize ' . ((&lines * 27 + 28) / 57)
exe 'vert 2resize ' . ((&columns * 76 + 115) / 231)
exe '3resize ' . ((&lines * 27 + 28) / 57)
exe 'vert 3resize ' . ((&columns * 76 + 115) / 231)
exe '4resize ' . ((&lines * 27 + 28) / 57)
exe 'vert 4resize ' . ((&columns * 115 + 115) / 231)
exe '5resize ' . ((&lines * 27 + 28) / 57)
exe 'vert 5resize ' . ((&columns * 115 + 115) / 231)
argglobal
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
...
wincmd w
argglobal
if bufexists('data/mrt.json') | buffer data/mrt.json | else | edit data/mrt.json | endif
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
2
normal! zo
let s:l = 266 - ((18 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
266
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 64 - ((26 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
wincmd w
argglobal
if bufexists('processdata.py') | buffer processdata.py | else | edit processdata.py | endif
setlocal autoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
95
normal! zc
let s:l = 289 - ((287 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
289
